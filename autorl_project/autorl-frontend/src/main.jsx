...
const isStaticHost = typeof window !== 'undefined' && (
  // hostnames known to often not provide SPA rewrite rules in many preview/static setups
...
// For local development (localhost) prefer BrowserRouter so dev server works
