...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800">
      {/* Navigation Menu */}
      <nav className="border-b bg-white/70 dark:bg-slate-900/70 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-lg flex items-center justify-center">
              <Smartphone className="w-6 h-6 text-white" />
            </div>
            <h1 className="text-2xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">AutoRL</h1>
          </div>
          <div className="flex gap-4">
            <Link to="/" className="font-semibold hover:text-indigo-600">Landing</Link>
            <Link to="/dashboard" className="font-semibold hover:text-indigo-600">Dashboard</Link>
            <Link to="/devices" className="font-semibold hover:text-indigo-600">Devices</Link>
            <Link to="/tasks" className="font-semibold hover:text-indigo-600">Tasks</Link>
            <Link to="/policies" className="font-semibold hover:text-indigo-600">Policies</Link>
          </div>
        </div>
      </nav>
